...
public class TargetHud extends HudElement {
    ...
    private final Setting<ModeEn> Mode = new Setting<>("Mode", ModeEn.cetrefilliFun);
    ...
    public void onEnable() {
        try {
            ...
            sendMessage(".minecraft -> cetrefilli.fun -> misc -> images -> thud.png");
        }
    }
    ...
    public void onRender2D(DrawContext context) {
        ...
        if (animation.getAnimationd() > 0) {
            ...
            switch (Mode.getValue()) {
                case cetrefilliFun -> renderCetrefilliFun(context, health, animationFactor);
    ...
    private void renderCetrefilliFun(DrawContext context, float health, float animationFactor) {
        float hurtPercent = target.hurtTime / 6f;
    ...
    public enum ModeEn {
        cetrefilliFun, NurikZapen, CelkaPasta
    }
}