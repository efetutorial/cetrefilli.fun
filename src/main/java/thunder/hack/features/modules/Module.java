...
public abstract class Module {
    ...
    public void enable() {
        ...
        if (!ignoreSoundList.contains(getDisplayName())) {
            NOTIFICATION.publicity(getDisplayName(), "Modül etkinleştirildi!", 2, Notification.Type.ENABLED);
    ...
    public void disable() {
        ...
        if (!ignoreSoundList.contains(getDisplayName())) {
            NOTIFICATION.publicity(getDisplayName(), "Modül devre dışı bırakıldı!", 2, Notification.Type.DISABLED);
