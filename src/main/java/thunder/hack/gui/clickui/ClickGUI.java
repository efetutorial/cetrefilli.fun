        ...
        if (ModuleManager.clickGui.tips.getValue() && !close)
            FontRenderers.sf_medium.drawString(context.getMatrices(),
                    isRu() ? "Щелкните левой кнопкой мыши, чтобы включить модуль." +
                            ...
                            :
                            "Sol fare tıklaması ile modülü etkinleştir" +
                                    "\nSağ fare tıklaması ile modül ayarlarını aç" +
                                    "\nOrta fare tıklaması ile modülü tuşa ata" +
                                    "\nCtrl + F ile arama yap" +
                                    "\nSürükle ve bırak ile konfigürasyonu yükle" +
                                    "\nShift + Sol fare tıklaması ile modülün Array list'te görünürlüğünü değiştir" +
                                    "\nKaydırıcı üzerinde orta fare tıklaması ile değeri klavyeden gir" +
                                    "\nDelete + Sol fare tıklaması ile modülü sıfırla",
